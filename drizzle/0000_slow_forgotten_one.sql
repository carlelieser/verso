...
CREATE TABLE `journal` (
	...
	`color` text DEFAULT '#7A8A8C' NOT NULL,
	`display_order` integer DEFAULT 0 NOT NULL,
	`created_at` integer NOT NULL,
	`updated_at` integer NOT NULL
);
--> statement-breakpoint
CREATE INDEX `journal_order_idx` ON `journal` (`display_order`);--> statement-breakpoint
CREATE UNIQUE INDEX `journal_name_idx` ON `journal` (`name`);--> statement-breakpoint
