...
export default function HomeScreen(): React.JSX.Element {
	const {journalId: paramJournalId} = useLocalSearchParams<{ journalId?: string }>();
	...
	const [selectedJournalId, setSelectedJournalId] = useState<string | null>(paramJournalId ?? null);
